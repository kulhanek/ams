#ifndef HostSubSystemDesktopH
#define HostSubSystemDesktopH
// =============================================================================
...
class AMS_PACKAGE CHostSubSystemDesktop : public CHostSubSystem {
public:
// constructor -----------------------------------------------------------------
    CHostSubSystemDesktop(const CFileName& config_file);
    ~CHostSubSystemDesktop(void);
