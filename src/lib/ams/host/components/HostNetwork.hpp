#ifndef HostSubSystemNetworkH
#define HostSubSystemNetworkH
// =============================================================================
...
class AMS_PACKAGE CHostSubSystemNetwork : public CHostSubSystem {
public:
// constructor -----------------------------------------------------------------
    CHostSubSystemNetwork(const CFileName& config_file);
    ~CHostSubSystemNetwork(void);
...
private:
    bool                        CachedData;
    std::list<CSmallString>     NetDevs;
    CSmallString                NetFilters;
    std::list<CSmallString>     ArchTokens;

    // helper methods
    void GetCPUModelAndFlags(void);
};
