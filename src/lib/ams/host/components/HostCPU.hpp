#ifndef HostSubSystemCPUH
#define HostSubSystemCPUH
// =============================================================================
...
class AMS_PACKAGE CHostSubSystemCPU : public CHostSubSystem {
public:
// constructor -----------------------------------------------------------------
    CHostSubSystemCPU(const CFileName& config_file);
    ~CHostSubSystemCPU(void);
