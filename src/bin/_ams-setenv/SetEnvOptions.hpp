...
public:
    ...
    "It updates AMS_NCPU, OMP_NUM_THREADS, MKL_NUM_THREADS, AMS_NGPU, AMS_NNODE, AMS_NODEFILE and AMS_GPUFILE "
    "as well as INF_NCPU, INF_NGPU, INF_NNODE, INF_NODEFILE and INF_GPUFILE variables "
