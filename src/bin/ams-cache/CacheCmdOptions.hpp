#ifndef CacheCmdOptionsH
#define CacheCmdOptionsH
// =============================================================================
// AMS
// -----------------------------------------------------------------------------
...
class CCacheCmdOptions : public CSimpleOptions {
public:
    // constructor - tune option setup
    CCacheCmdOptions(void);
    ...
    CSO_PROG_DESC_BEGIN
    "<b><red>ams-cache</red></b> manages module cache of active site or all sites."
    CSO_PROG_DESC_END
    ...
    "<b>Arguments:</b>\n"
    "   <cyan><b>action</b></cyan>          operation which should be performed\n"
    "\n"
    "Supported actions for the active site:\n"
