...
public:
    ...
    CSO_MAP_OPT(bool,                           /* option type */
                ...
                "hw",                      /* long option name */
                NULL,                           /* parametr name */
                "print HW description")   /* option description */
    //----------------------------------------------------------------------
    CSO_MAP_OPT(bool,                           /* option type */
                NodeResource,                        /* option name */
                false,                          /* default value */
                false,                          /* is option mandatory */
                '\0',                           /* short option name */
                "noderesources",                      /* long option name */
                NULL,                           /* parametr name */
                "print node resources suitable for a PBSPro node configuration")   /* option description */
    //----------------------------------------------------------------------
    CSO_MAP_OPT(bool,                           /* option type */
                Verbose,                        /* option name */
                false,                          /* default value */
